...
A roboton, egy performáns számítógép felelős a ROSmaster és egyéb kiszolgáló nodok futtatásáért, a rendszerhez USB \ref{fig:CmodA7architektura} csatlakozóval kapcsolódó modulok:
\begin{table}[H]
\center
    \begin{tabular}{llll}
        \hline
