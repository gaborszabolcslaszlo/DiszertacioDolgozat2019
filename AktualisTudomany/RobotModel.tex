...
A $COM$ pontban mert értékek az \myeqref{eq:allapot} segítségével szamolhatjuk a globális $VNR$ -be.
...
A kerekek előírt nyomatékát megkapjuk ha a  \myeqref{eq:eloirtnyomatek} -t használva. Az $u$ szabályzó jelet kiszámíthatjuk ha az \myeqref{eq:controllertorque1}-t használjuk. Jelölje a $K_\eta$ a szabályzó paraméterei. Csuszás szabályzó  $\sigma_\eta$ parameteri $\rho_v$ linearis sebességért, és $\rho_w$ szögsebességért felelős. Mindkét paraméter nagyobb kell legyen mint a zaj $n$ megfelelő érteké.
...
%\begin{figure}[!ht]
% \centering
% \includesvg[width = 300pt]{SajatRobot/SzerkAbrak/drawing1.svg}
%\end{figure}
