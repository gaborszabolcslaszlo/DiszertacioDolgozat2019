...
%\input{JelolesekEsRovditesek.tex}
...
%\renewcommand{\section}{\fillbreak\oldsection}
...
%\input{compileFigures.tex}

%\input{compileFigures.tex}

%\tracingall

%\input{Fedolap/Fedolap.tex}\newpage

%\input{Declaratie.tex}
...
\input{Bevezeto/Bevezeto.tex}
\input{AktualisTudomany/AktTudomany.tex}
\input{SajatRobot/sajatrobot.tex}

\input{Meresek/Meres1.tex}

\input{KiertekelesEsEredmenyek.tex}
