...
A \ref{fig:HlejtoKerek} látható a PWM beavatkozó jelek a BL és BR kerekeken 20\% nagyobb beavatkozó jel szükséges ugyanannak a referencia jelnek a követésére.

A kerekek előírt forgási sebessége 15\degree/s, 0.5m \ref{fig:Hlejto1}  megtétele után a BL és a BR kerekek 10 cm mélyen a homokba süllyedtek és a robot elakadt \ref{fig:Hlejto1}. Egy másik észrevétel, hogy a FL és FR kerekek egyáltalán nem süllyedtek be a talajba forgás közben, ami a kisebb merőleges nyomóerőnek tulajdonítható. 
...
\begin{figure}[H]
  ...
  \caption{Homokos és kavicsos lejtőn felfele mozgás}
