...
A lejtő meredeksége 45\degree, a szerkezete homokos, nagyobb méretű szilárd darakkal amelyek elérik a 4cm átmérőt is.
...
A kereke előirt forgási sebessége 15\degree/s, 0.5m \ref{fig:Hlejto2}  megtétele után a BL és a BR kerek 10 cm mélyen a homokba sülyetek és a robot elakadt \ref{fig:Hlejto1}. Egy másik észrevétel hogy a FL es FR kerek egyáltalan nem sülyedtek be a talajba forgás közben ami a kissebb merőleges nyomóerőnek tulajdonitható. 
